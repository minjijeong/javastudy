...
public class MyLinkedList<E> implements List<E> {
	...
	public void add(int index, E element) {
		// https://docs.oracle.com/javase/8/docs/api/java/util/LinkedList.html#add-java.lang.Object-
		//TODO: FILL THIS IN!
		if(index == 0){
	...
	public E remove(int index) {
		// https://docs.oracle.com/javase/8/docs/api/java/util/LinkedList.html#remove-java.lang.Object-
		//TODO: FILL THIS IN!
		E element = get(index);
		if(index == 0){
			head = head.next;
